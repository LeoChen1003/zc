  ...
  <div class="whiteBack">
    <div class="header headerW">
      <div class="header_logo"  @click="$router.push('/')">
          <svg-icon
                  icon-class="logo"
                  class-name="index_svg_b"
                  style="width:15rem;height:1.5rem;"
          ></svg-icon>
          <svg-icon
                  icon-class="logo_w"
                  class-name="index_svg_w"
                  style="width:15rem;height:1.5rem;"
          ></svg-icon>
      </div>
...
.whiteBack,.whiteBack1{
  ...
  .showPro{
    ...
    .showPro_l,.showPro_r1{
        float: left;
    }
    .showPro_l{
        width: 34.93rem;
        height: 100%;
        .showPro_l_btn1,.showPro_l_btn2,.showPro_l_btn3{
            width:8.25rem;
            height:2rem;
            background:rgba(0,0,0,1);
            border-radius:1rem;
